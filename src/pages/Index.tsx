...
import { ArrowRight, Menu, X, Clock, Shield, Zap, HeartHandshake, Users, TrendingUp, Star, ChevronDown, Heart, Sparkles, Target } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section id="love" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <Card className="group hover:shadow-xl transition-all duration-700 hover:-translate-y-2 bg-gradient-to-br from-pink-50 to-rose-50 border-0">
            ...
            <Card className="group hover:shadow-xl transition-all duration-700 hover:-translate-y-2 bg-gradient-to-br from-rose-50 to-pink-50 border-0">
              <CardContent className="p-8">
      ...
      <section id="contact" className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative container mx-auto text-center z-10">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 max-w-2xl mx-auto shadow-2xl transform hover:scale-105 transition-all duration-700">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Let's Create Magic</h2>
            <p className="text-xl mb-8 text-white/90">Ready to transform your workflow? Let's talk.</p>
            
            <div className="space-y-4">
              <Button 
                size="lg" 
                className="w-full bg-white text-primary hover:bg-white/90 px-8 py-6 text-lg font-semibold rounded-xl shadow-lg hover:shadow-2xl transform transition-all duration-700 hover:scale-105"
                onClick={() => window.open('https://calendly.com/hie-yashraj', '_blank')}
              >
                Schedule a Call <ArrowRight className="ml-2 w-6 h-6" />
              </Button>
              
              <p className="text-white/80 text-sm">
                No pressure. Just pure automation goodness.
              </p>
            </div>
          </div>
        </div>
